            ...
            <div style={patient.headerContent}>
              ...
              <div>
                <NotePencil
                  size={25}
                  color="#2DA9B5"
                  onClick={() => handleEditToggle("vitals")}
                  style={{ cursor: "pointer" }}
                />
                <CaretDown
                  size={25}
                  color="#2DA9B5"
                  onClick={() => handleVisibilityToggle("vitals")}
                  style={{ cursor: "pointer" }}
                />
              </div>
            </div>
              ...
              {editMode.vitals ? (
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleChange(e, "vitals", "respiratoryRate")
                    }
                  />
                  <br />
                ...
                <div>
                  ...
                  <br />
                  <span style={patient.attribute}>
                    Frequência Respiratória:{" "}
                  </span>
                  <span style={patient.value}>
                    {vitals.respiratoryRate} mrm
                  </span>
                  <br />
      ...
      <div style={patient.containerP}>
        <div style={patient.containerOutline}>
            ...
            <div style={patient.headerContent}>
              ...
              <div>
                <CaretDown
                  size={25}
                  color="#2DA9B5"
                  onClick={() => handleVisibilityToggle("anamnese")}
                  style={{ cursor: "pointer" }}
                />
              </div>
            </div>
          ...
          >
            ...
            >
              <Smiley size={70} style={{ cursor: "pointer" }} />
              <span>0</span>
              <span>Sem dor</span>
            </div>
            <div
            ...
            >
              <SmileyBlank size={70} style={{ cursor: "pointer" }} />
              <span>1</span>
            </div>
            <div
              style={{
            ...
            >
              <SmileyMeh size={70} style={{ cursor: "pointer" }} />
              <span>2</span>
            </div>
            <div
              style={{
            ...
            >
              <SmileySad size={70} style={{ cursor: "pointer" }} />
              <span>3</span>
            </div>
            <div
              style={{
            ...
            >
              <SmileyNervous size={70} style={{ cursor: "pointer" }} />
              <span>4</span>
